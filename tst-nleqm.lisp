...
;; @Copyright Copyright 1995-2010 by Mitch Richling.  All rights reserved.
;; @brief     Tests for :mjr_nleqm.@EOL
;; @Keywords  
;; @Std       Common Lisp
;;
;;            
...
;;----------------------------------------------------------------------------------------------------------------------------------
(defpackage :MJR_NLEQM-TESTS (:USE :COMMON-LISP :LISP-UNIT :MJR_NLEQM :MJR_VEC :MJR_EPS))
...
; (mjr_plot_func-r2-r1 (lambda (x y) (min 1/2 (mjr_vec_norm-two (tf2 x y)))) :xlim '(-1.5 1.5) :ylim '(-2.2 2.2) :type :f :n 50 :m 50)
