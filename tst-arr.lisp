...
;; @brief     Unit tests for use-arr.lisp@EOL
;; @Keywords  
;; @Std       Common Lisp
;;
;;            
...
;;----------------------------------------------------------------------------------------------------------------------------------
(defpackage :MJR_ARR-TESTS (:USE :COMMON-LISP :LISP-UNIT :MJR_ARR :MJR_VEC :MJR_PRNG))
...
(define-test mjr_arr_get-subarray2
  ...
  ;; MJR SCM NOTE <2012-09-05 15:03:36 CDT> mjr_arr_get-subarray2: Add error cases: 3D array and vector
  )
