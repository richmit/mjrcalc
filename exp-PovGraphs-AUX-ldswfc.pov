...
#declare h  = 13;   // Height of camera
#declare r  = 12;   // Distance form center of rotation
camera {
   location <cos(0.05*2*pi)*r+cx,sin(0.05*2*pi)*r+cy,h>
   look_at  <cx,cy,-2>
   sky <0,0,1>
   up <0,0,1>
   right <0,16/9,0>
...
#declare vertexDiam=0.05;
#declare lineDiam=0.05;
