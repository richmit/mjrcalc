...
;;----------------------------------------------------------------------------------------------------------------------------------
(define-test mjr_dquad_get-axis-attr-by-index    
  (assert-equalp a-x-n     (mjr_dquad_get-axis-attr-by-index a 0 :dq-nam))
  (assert-equalp a-y-n     (mjr_dquad_get-axis-attr-by-index a 1 :dq-nam))
  (assert-equalp a-x-t     (mjr_dquad_get-axis-attr-by-index a 0 :dq-typ))
  (assert-equalp a-y-t     (mjr_dquad_get-axis-attr-by-index a 1 :dq-typ))
  ;; Errors (bad index)
  (assert-error 'error  (mjr_dquad_get-axis-attr-by-index a 't  :dq-nam))
  (assert-error 'error  (mjr_dquad_get-axis-attr-by-index a nil :dq-nam))
  (assert-error 'error  (mjr_dquad_get-axis-attr-by-index a 1.4 :dq-nam))
  (assert-error 'error  (mjr_dquad_get-axis-attr-by-index a -1  :dq-nam))
  (assert-error 'error  (mjr_dquad_get-axis-attr-by-index a 5   :dq-nam))
  ;; Errors (bad attr name)
  (assert-error 'error  (mjr_dquad_get-axis-attr-by-index a 0 't  ))
  (assert-error 'error  (mjr_dquad_get-axis-attr-by-index a 0 nil ))
  (assert-error 'error  (mjr_dquad_get-axis-attr-by-index a 0 1.4 ))
  (assert-error 'error  (mjr_dquad_get-axis-attr-by-index a 0 -1  ))
  (assert-error 'error  (mjr_dquad_get-axis-attr-by-index a 0 5   ))
)

;;----------------------------------------------------------------------------------------------------------------------------------
(define-test mjr_dquad_get-data-attr-by-index    

  (assert-equalp a-z1-t     (mjr_dquad_get-data-attr-by-index a 0 :dq-typ))
  (assert-equalp a-z2-t     (mjr_dquad_get-data-attr-by-index a 1 :dq-typ))
  (assert-equalp a-z3-t     (mjr_dquad_get-data-attr-by-index a 2 :dq-typ))
  (assert-equalp a-z1^2-t   (mjr_dquad_get-data-attr-by-index a 3 :dq-typ))
  (assert-equalp a-z1*z2-t  (mjr_dquad_get-data-attr-by-index a 4 :dq-typ))
  (assert-equalp a-z1+z2-t  (mjr_dquad_get-data-attr-by-index a 5 :dq-typ))
  (assert-equalp a-x+y+z1-t (mjr_dquad_get-data-attr-by-index a 6 :dq-typ))
  (assert-equalp a-z1-n     (mjr_dquad_get-data-attr-by-index a 0 :dq-nam))
  (assert-equalp a-z2-n     (mjr_dquad_get-data-attr-by-index a 1 :dq-nam))
  (assert-equalp a-z3-n     (mjr_dquad_get-data-attr-by-index a 2 :dq-nam))
  (assert-equalp a-z1^2-n   (mjr_dquad_get-data-attr-by-index a 3 :dq-nam))
  (assert-equalp a-z1*z2-n  (mjr_dquad_get-data-attr-by-index a 4 :dq-nam))
  (assert-equalp a-z1+z2-n  (mjr_dquad_get-data-attr-by-index a 5 :dq-nam))
  (assert-equalp a-x+y+z1-n (mjr_dquad_get-data-attr-by-index a 6 :dq-nam))
  ;; Errors (bad index)
  (assert-error 'error  (mjr_dquad_get-data-attr-by-index a 't  :dq-nam))
  (assert-error 'error  (mjr_dquad_get-data-attr-by-index a nil :dq-nam))
  (assert-error 'error  (mjr_dquad_get-data-attr-by-index a 1.4 :dq-nam))
  (assert-error 'error  (mjr_dquad_get-data-attr-by-index a -1  :dq-nam))
  (assert-error 'error  (mjr_dquad_get-data-attr-by-index a 7   :dq-nam))
  ;; Errors (bad attr name)
  (assert-error 'error  (mjr_dquad_get-data-attr-by-index a 0 't  ))
  (assert-error 'error  (mjr_dquad_get-data-attr-by-index a 0 nil ))
  (assert-error 'error  (mjr_dquad_get-data-attr-by-index a 0 1.4 ))
  (assert-error 'error  (mjr_dquad_get-data-attr-by-index a 0 -1  ))
  (assert-error 'error  (mjr_dquad_get-data-attr-by-index a 0 7   ))
)
