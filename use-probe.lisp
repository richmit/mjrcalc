...
; MJR TODO NOTE mjr_probe_ecwt2icdf: Check implimentation -- the (1+ i) is odd...
    (eval `(lambda (r)
...
(defun mjr_probe_ecfreq2prng (ecfreq)
  ...
  ;; MJR TODO NOTE <2013-06-09 23:28:20 CDT> mjr_probe_ecfreq2prng: Add option to select random number function.
  ;; MJR TODO NOTE <2013-07-07 21:47:49 CDT> mjr_probe_ecwt2icdf: USE QMESH!!
  (if (listp ecfreq)
